...
[:material-language-javascript: JavaScript](https://www.javascript.com/){target=_blank} - is the programming language of the Web.
...
[:material-terrain: Rocky](https://rockylinux.org/){target=_blank}
